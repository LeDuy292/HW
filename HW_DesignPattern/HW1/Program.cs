...
namespace DesignPatterns.Homework
{
    ...
    public class Truck : IVehicle
    {
        ...
        public void DisplayInfo()
        {
            Console.WriteLine($"Type Fuel : {FuelType} LoadCapacity : {LoadCapacity} in tons");
        }

        public void Drive()
        {
            Console.WriteLine($"Riding {FuelType} truck  with {LoadCapacity} in tons");
        }
    }
    // Abstract Creator
    ...
    public class TruckFactory : VehicleFactory
    {
        ...
        public TruckFactory(string fuelType, double loadCapacity)
        {
            _fuelType = fuelType;
        ...
        public override IVehicle CreateVehicle()
        {
            ...
            return new Truck(_fuelType, _loadCapacity);
        }
    }
    class Program
    {
        static void Main(string[] args)
        {
            ...
            VehicleFactory truck = new TruckFactory("Diesel", 10);
            truck.OrderVehicle();
